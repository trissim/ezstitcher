...
from z_stack_handler import organize_zstack_folders

# Image processing imports - only keep what's used
from image_process import assemble_image_subpixel, tophat, create_weighted_composite, process_bf
from image_process import create_weighted_composite
...
if __name__ == "__main__":
    #from z_stack_handler import preprocess_plate_folder, modified_process_plate_folder
    ...
    plate_folders = [
            #'/home/ts/nvme_usb/IMX/processed_test-time-mfd-hips-10x_Plate_12990/test-time-mfd-hips-10x_Plate_12990',
            '/home/ts/nvme_usb/IMX/ctbdpga-b01-1_Plate_12934_all/ctbdpga-b01-1_Plate_12934'
        #'/home/ts/nvme_usb/IMX/axotomy_fcncpc_densities/test-time-mfd-hips-10x-axotomy-fc-ncpc_Plate_12999',
        #'/home/ts/nvme_usb/IMX/axotomy_fcncpc_densities/test-time-mfd-hips-10x-axotomy-fc-ncpc_Plate_13002'
        #'/home/ts/nvme_usb/IMX/axotomy_fcncpc_densities/test-time-mfd-hips-10x-axotomy-fc-ncpc_Plate_13002'
    ]
    ...
    for folder in plate_folders:
        process_plate_folder(
            ...
            tile_overlap=10,  # Example of passing custom overlap
            max_shift=50       # Example of passing custom max_shift
        )
